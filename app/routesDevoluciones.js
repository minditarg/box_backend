...
module.exports = function (app,connection, passport) {
  ...
  app.post('/insert-devoluciones', bodyJson,checkConnection, function (req, res) {
      ...
      //  console.log("fecha: " + moment(req.body.fechaIdentificador, "MM/DD/YYYY"));
        ...
        connection.query("INSERT INTO devoluciones (descripcion,id_modulo,id_user,fecha) VALUES (?)", [arrayIns], function (error, result) {
          if (error) {
          ...
          connection.query(sql, [values], function (error, results) {
            ...
            var sql = "INSERT INTO auditoria_stock (id_movimiento,cantidad,id_user,fecha,id_devolucion,id_insumo) VALUES ?";
            var values = [];
            req.body.detalle.forEach(element => {
